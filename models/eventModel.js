...
const sheetId = "15hfo1oHXjxAt57h5k9Ijft10L6ZPKFHj-X7ivbHfdDg";
...
module.exports = class EventModel {
    constructor(title, location, images, videos, date, status = 1, id = 0) {
        this.id = id;
        this.title = title;
            ...
            sheets.spreadsheets.values.update(
                ...
                (err, res) => {
                    if (err) {
                        ...
                        console.log(
                            "Event saved successfully to Google Sheets!"
                        );
                    }
                }
            );
